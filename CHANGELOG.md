...
* Empty workspace: bar_geometry now reports middle_width=0 when no client is focused, so overlay clients (wmenu) fall back to the dark standalone theme instead of the purple pill theme.
